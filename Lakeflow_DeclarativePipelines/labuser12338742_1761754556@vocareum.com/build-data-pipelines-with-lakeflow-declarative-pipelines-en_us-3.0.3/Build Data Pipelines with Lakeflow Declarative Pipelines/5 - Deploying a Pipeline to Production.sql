...
-- MAGIC
-- MAGIC This course includes a complete Lakeflow Declarative Pipeline project that has already been created.  In this section, you'll explore the Lakeflow Declarative Pipeline and modify its settings for production use.
-- MAGIC
