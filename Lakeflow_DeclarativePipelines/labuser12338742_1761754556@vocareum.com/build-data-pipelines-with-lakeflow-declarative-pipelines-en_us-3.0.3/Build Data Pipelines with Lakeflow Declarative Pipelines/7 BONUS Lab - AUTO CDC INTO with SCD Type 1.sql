...
-- MAGIC
-- MAGIC ### REQUIREMENTS:
-- MAGIC It’s your job to complete the Lakeflow Declarative Pipeline by adding the `AUTO CDC` statement to perform SCD Type 1.
-- MAGIC
...
-- MAGIC
-- MAGIC [AUTO CDC INTO (Lakeflow Declarative Pipelines)](https://docs.databricks.com/gcp/en/dlt-ref/dlt-sql-ref-apply-changes-into)
