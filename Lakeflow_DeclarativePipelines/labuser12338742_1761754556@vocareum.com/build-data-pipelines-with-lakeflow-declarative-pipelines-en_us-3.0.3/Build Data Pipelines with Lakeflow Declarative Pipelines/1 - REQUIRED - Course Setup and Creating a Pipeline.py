...
# MAGIC
# MAGIC    f. This will open your Lakeflow Declarative Pipeline within the **Lakeflow Pipelines Editor**. By default, the project creates multiple folders and sample files for you as a starter. You can use this sample folder structure or create your own. Notice the following in the pipeline editor:
# MAGIC
