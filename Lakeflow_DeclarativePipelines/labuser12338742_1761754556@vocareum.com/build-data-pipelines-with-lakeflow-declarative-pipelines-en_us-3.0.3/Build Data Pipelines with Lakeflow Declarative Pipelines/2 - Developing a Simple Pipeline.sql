...
-- MAGIC
-- MAGIC In this demonstration, we will create a simple Lakeflow Declarative Pipeline project using the new **Lakeflow Pipeline Editor** with declarative SQL.
-- MAGIC
-- MAGIC
...
-- MAGIC - Navigate the Lakeflow Declarative Pipeline Lakeflow Pipeline Editor to modify pipeline settings and ingest the raw data source file(s).
...
-- MAGIC %md
-- MAGIC ## B. Developing and Running a Lakeflow Declarative Pipeline with Pipeline Editor
-- MAGIC
-- MAGIC This course includes a simple, pre-configured Lakeflow Declarative Pipeline to explore and modify. 
-- MAGIC
...
-- MAGIC       - `/Workspace/Users/your-lab-user-name/build-data-pipelines-with-lakeflow-declarative-pipelines-3.x.x/Build Data Pipelines with Lakeflow Declarative Pipelines/2 - Developing a Simple Pipeline Project`
-- MAGIC
-- MAGIC     - **Source code paths**: Within the same root folder as above, select the **orders** folder: 
-- MAGIC       - `/Workspace/Users/your-lab-user-name/build-data-pipelines-with-lakeflow-declarative-pipelines-3.x.x/Build Data Pipelines with Lakeflow Declarative Pipelines/2 - Developing a Simple Pipeline Project/orders`
-- MAGIC
