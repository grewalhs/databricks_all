...
-- MAGIC
-- MAGIC This demonstration includes the simple starter Lakeflow Declarative Pipeline that has already been created in the previous demonstration. We will continue to build on it to explore it's capabilities.
